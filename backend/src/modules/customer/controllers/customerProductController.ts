...
export const getProducts = async (req: Request, res: Response) => {
  try {
    ...
    // Note: If no location given, nearbySellerIds stays empty.
    // Products will still be returned but marked isAvailable: false. 
    // The UI can decide how to present that.
