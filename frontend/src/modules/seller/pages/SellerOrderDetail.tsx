...
export default function SellerOrderDetail() {
  ...
  const handleExportPDF = () => {
    ...
    yPos += 5;
    doc.text("Website: https://vrumarket.com", margin, yPos);
    yPos += 12;
    ...
    doc.text("Bill Generated by vrumarket.com", pageWidth / 2, yPos, {
      align: "center",
    });
    yPos += 8;
    ...
    doc.setFontSize(8);
    doc.text(
      "Copyright © 2026. Developed By vrumarket.com",
      pageWidth / 2,
      yPos,
      { align: "center" }
    );
        ...
        <div className="bg-white px-4 sm:px-6 py-6">
          ...
          <div className="border-t border-dashed border-neutral-300 pt-4">
            <p className="text-sm text-neutral-600 text-center">
              Bill Generated by vrumarket.com
            </p>
          </div>
        </div>
      </div>
