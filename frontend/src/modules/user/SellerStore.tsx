        ...
        <div className="min-h-screen bg-neutral-50 pb-20">
            ...
            <div className="relative">
                <div className="w-full aspect-[2.2/1] bg-gray-200 overflow-hidden">
                    ...
                    />
                    {!scrolled && <div className="absolute inset-0 bg-gradient-to-b from-black/40 via-transparent to-transparent pointer-events-none" />}
                </div>
            ...
            <div className="sticky top-[60px] z-40 bg-white/80 backdrop-blur-md px-4 py-3.5 flex gap-2 overflow-x-auto no-scrollbar scroll-smooth shadow-sm border-b border-gray-100">
                ...
                <div className="w-px h-8 bg-gray-100 mx-1 flex-shrink-0" />
                ...
                {initialCategories.map((cat: any) => (
                    <button
                        ...
                        className={`whitespace-nowrap px-5 py-2 rounded-xl text-[13px] font-bold transition-all active:scale-95 border ${
            ...
            <AnimatePresence>
                {!scrolled && (
                    ...
                    >
                        <button className="bg-gray-900 text-white px-5 py-3.5 rounded-full flex items-center gap-2.5 shadow-2xl font-black text-[11px] uppercase tracking-widest hover:scale-105 active:scale-95 transition-all">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
