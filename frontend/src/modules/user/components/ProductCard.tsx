      ...
      >
        ...
        {showHeartIcon && (
          <button
            ...
            className="absolute top-1.5 right-1.5 z-30 w-7 h-7 rounded-full bg-white/90 backdrop-blur-sm flex items-center justify-center hover:bg-white transition-all shadow-sm border border-gray-100"
          >
            <svg
              width="14"
              height="14"
