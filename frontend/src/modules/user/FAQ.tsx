...
export default function FAQ() {
  ...
  return (
    <div className="pb-24 md:pb-8 bg-white min-h-screen">
      {/* Header */}
      <div className="bg-gradient-to-b from-violet-200 via-violet-100 to-white pb-6 md:pb-8 pt-12 md:pt-16">
          ...
          <div className="flex flex-col items-center mb-4 md:mb-6">
            <div className="w-20 h-20 md:w-24 md:h-24 rounded-full bg-white flex items-center justify-center mb-3 md:mb-4 border-2 border-white shadow-sm">
              <svg
                ...
                viewBox="0 0 24 24"
                fill="none"
                className="text-violet-600 md:w-12 md:h-12">
                <path
        ...
        <div className="max-w-3xl mx-auto">
          {loading ? (
            <div className="space-y-4">
              {[1, 2, 3, 4, 5].map((i) => (
                <div key={i} className="h-16 bg-violet-50 animate-pulse rounded-lg"></div>
              ))}
            </div>
          ) : faqs.length > 0 ? (
            ...
            <div className="text-center py-12">
              <p className="text-neutral-500 italic">No FAQs available at the moment.</p>
            </div>
          )}

          {/* Contact Support Section */}
          <div className="mt-8 bg-gradient-to-br from-violet-50 to-violet-100 rounded-lg p-6 border border-violet-200">
