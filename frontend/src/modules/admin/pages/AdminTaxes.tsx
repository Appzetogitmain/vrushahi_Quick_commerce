        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 h-full">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-neutral-200 flex flex-col">
            ...
            <div className="p-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-neutral-100">
              ...
              <div className="flex items-center gap-2">
                <div className="relative" tabIndex={-1} onBlur={(e) => { if (!e.currentTarget.contains(e.relatedTarget)) setIsExportOpen(false); }}>
                  <button
                ...
                <div className="relative">
                  {!searchTerm && (
                    <span className="absolute left-2 top-1/2 -translate-y-1/2 text-neutral-400 text-xs pointer-events-none">
                      Search:
                    </span>
                  )}
                  <input
                    type="text"
                    className={`pr-3 py-1.5 bg-neutral-100 border-none rounded text-sm focus:ring-1 focus:ring-teal-500 w-48 ${
