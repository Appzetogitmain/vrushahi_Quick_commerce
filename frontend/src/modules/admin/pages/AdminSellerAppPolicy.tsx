    ...
    <div className="flex flex-col h-full">
      ...
      <div className="bg-white px-4 sm:px-6 py-4 border-b border-neutral-200">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h1 className="text-xl sm:text-2xl font-bold text-neutral-900">Seller App Policies</h1>
            <p className="text-sm text-neutral-500 mt-1">Manage Privacy Policy and Terms & Conditions for Sellers</p>
          </div>
          <div className="text-sm text-neutral-600">
            <span className="text-green-600">Home</span> / <span className="text-neutral-900">Seller Policies</span>
          </div>
        </div>
      </div>
              ...
              <button
                ...
                className={`px-6 py-2 rounded-full text-sm font-semibold transition-all ${
                  selectedType === type
                    ...
                    : 'bg-white text-neutral-600 border border-neutral-200 hover:border-green-500'
                }`}
              >
                {type}
              </button>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="p-4 sm:p-6">
                  <div>
                    ...
                    <textarea
                      ...
                      rows={20}
                      required
                      className="w-full px-4 py-3 border border-neutral-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 resize-y font-mono leading-relaxed"
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="flex justify-end gap-4">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="bg-green-600 hover:bg-green-700 text-white px-8 py-2.5 rounded-lg text-base font-medium transition-colors shadow-lg shadow-green-600/20 disabled:opacity-50"
                >
